...
public final class SettingsUiSchema {
    ...
    private static final List<Settings.Setting<?>> ORDERED = Collections.unmodifiableList(Arrays.asList(
            ...
            Settings.SKIP_CHIP_STYLE,
            Settings.SKIP_CHIP_POSITION,
            ...
            Settings.LYRICS_FOCUS_POSITION,
            Settings.LYRICS_FOCUS_POSITION_CUSTOM_PERCENT,
            ...
            Settings.TRACK_INFO_ART_SIZE_CUSTOM_DP,
            Settings.TRACK_INFO_ART_RADIUS,
            Settings.TRACK_INFO_TEXT_ALIGN,
            Settings.TRACK_INFO_TEXT_SIZE_ADAPTIVE,
            ...
            Settings.LYRICS_BLUR_INTENSITY,
